...
# Training defaults
# ---------------------------------------------------------------------------
TRAIN_GPU_ARGS ?= --device cuda --p 3 --r 16 --d-model 192 --n-heads 4 --n-layers 3 --ffn-dim 768 --head-hidden 96 --dropout 0.1 --window-size 32 --attack-fraction 0.35 --attack-min-len 2 --attack-max-len 8 --n-train 32768 --n-val 4096 --samples 16384 --classes 32 --tokens-per-class 128 --epochs 20 --batch-size 128 --grad-accum 4 --lr 2e-4 --weight-decay 1e-2 --warmup-epochs 2 --num-workers 4 --alpha 0.5 --pos-weight 1.0 --margin-pos 0.1 --margin-neg 0.5 --save-every 5
...
ablate-small-model: setup
	$(VENV_PYTHON) scripts/train_anomaly_detector.py --device cuda --p 7 --r 16 --d-model 128 --n-heads 4 --n-layers 2 --ffn-dim 512 --head-hidden 64 --epochs 8 --n-train 32768 --n-val 4096 --batch-size 128 --grad-accum 4 --num-workers 4 --log-json results/ablate_small_model.json --log-md results/ablate_small_model.md

ablate-r8: setup
	$(VENV_PYTHON) scripts/train_anomaly_detector.py --device cuda --p 7 --r 8 --d-model 192 --n-heads 4 --n-layers 3 --ffn-dim 768 --head-hidden 96 --epochs 8 --n-train 32768 --n-val 4096 --batch-size 128 --grad-accum 4 --num-workers 4 --log-json results/ablate_r8.json --log-md results/ablate_r8.md

ablate-p3: setup
	$(VENV_PYTHON) scripts/train_anomaly_detector.py --device cuda --p 3 --r 16 --d-model 192 --n-heads 4 --n-layers 3 --ffn-dim 768 --head-hidden 96 --epochs 8 --n-train 32768 --n-val 4096 --batch-size 128 --grad-accum 4 --num-workers 4 --log-json results/ablate_p3.json --log-md results/ablate_p3.md

ablate-p5: setup
	$(VENV_PYTHON) scripts/train_anomaly_detector.py --device cuda --p 5 --r 16 --d-model 192 --n-heads 4 --n-layers 3 --ffn-dim 768 --head-hidden 96 --epochs 8 --n-train 32768 --n-val 4096 --batch-size 128 --grad-accum 4 --num-workers 4 --log-json results/ablate_p5.json --log-md results/ablate_p5.md

ablate-p7: setup
	$(VENV_PYTHON) scripts/train_anomaly_detector.py --device cuda --p 7 --r 16 --d-model 192 --n-heads 4 --n-layers 3 --ffn-dim 768 --head-hidden 96 --epochs 8 --n-train 32768 --n-val 4096 --batch-size 128 --grad-accum 4 --num-workers 4 --log-json results/ablate_p7.json --log-md results/ablate_p7.md
